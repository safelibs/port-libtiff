...
pub(crate) use directory::{
    ...
    number_of_directories, read_custom_directory, read_next_directory, safe_tiff_set_field_marshaled,
    set_directory, set_sub_directory, DirectoryState, TIFFRewriteDirectory, TIFFWriteDirectory,
};
